...
expect('GitHub token içerik', file('C:\\p\\src\\a.ts', 'const k = \"' + 'ghp_' + 'a'.repeat(36) + '\"'), 'deny');
expect('JWT içerik', file('C:\\p\\docs\\x.md', ['eyJhbGciOi', 'JIUzI1NiIsInR5cCI6', '.eyJ', 'pc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh4', '.', 'a'.repeat(24)].join('')), 'deny');
